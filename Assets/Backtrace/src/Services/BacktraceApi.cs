...
namespace Backtrace.Unity.Services
{
    ...
    internal class BacktraceApi : IBacktraceApi
    {
        ...
        private void AppendBodyToFile(string json)
        {
            lock (this)
            {
                using (System.IO.StreamWriter jsonOutputFile = new System.IO.StreamWriter("Requests-bodies.txt", true))
                {
                    jsonOutputFile.WriteLine("==========================================================================================");
                    jsonOutputFile.WriteLine(json);
                    jsonOutputFile.WriteLine("==========================================================================================");
                }
            }
        }
